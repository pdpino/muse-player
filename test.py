...
def test_tf(t, wave, plot_waves=False, min_freq=None, max_freq=None, window=None, step=None, n_cycles=None):
    """Test TF analysis on a wave."""

    # Compute FT
    power_stfft = tf.stfft(t, wave, window=window, step=step)
    power_conv = tf.convolute(t, wave, n_cycles=n_cycles)
